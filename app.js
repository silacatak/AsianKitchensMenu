...
//food recipe function for make html object items
...
koreanBTN =document.querySelector("#Korea")
//event listeners
koreanBTN.addEventListener("click",showKoreanFoods);
...
//Event Listeners
japanBTN.addEventListener("click",showJapan)
